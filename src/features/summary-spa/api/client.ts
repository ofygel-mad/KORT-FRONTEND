/**
 * features/summary-spa/api/client.ts
 * History data + aggregation utilities for Summary SPA.
 * Drop-in replacement for mock.ts.
 *
 * In production, historyData should come from a reporting API.
 * For now we seed 30 days locally — the store appends live events on top.
 */
